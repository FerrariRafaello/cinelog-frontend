...
function HomeContent() {
  ...
  useEffect(() => {
    ...
    // No URL filters means user is on the real home view.
    setQuery("");
    setMovies([]);
  }, [searchParams]);
  ...
  async function fetchMoviesByGenre(genreName: string, updateUrl = true) {
    ...
    try {
      ...
      const normalizedMovies = normalizeMovieResults(unique).slice(0, 60);
          ...
          <>
            ...
            {trending.length > 0 && (
              <div className="space-y-4 overflow-visible">
                <h2 className="text-xl sm:text-2xl font-semibold uppercase tracking-[0.14em] text-foreground/90 px-6 sm:px-12">Trending This Week</h2>
            ...
            {nowPlaying.length > 0 && (
              <div className="space-y-4 overflow-visible">
                <h2 className="text-xl sm:text-2xl font-semibold uppercase tracking-[0.14em] text-foreground/90 px-6 sm:px-12">Now Playing</h2>
                <div className="overflow-x-auto overflow-y-visible py-4 sm:py-5 px-6 sm:px-12 snap-x snap-mandatory">
                  <div className="flex gap-4 sm:gap-5 w-max pl-2 pr-2">
            ...
            {topRated.length > 0 && (
              <div className="space-y-4 overflow-visible">
                <h2 className="text-xl sm:text-2xl font-semibold uppercase tracking-[0.14em] text-foreground/90 px-6 sm:px-12">Worth Watching Again</h2>
                <div className="overflow-x-auto overflow-y-visible py-4 sm:py-5 px-6 sm:px-12 snap-x snap-mandatory">
                  <div className="flex gap-4 sm:gap-5 w-max pl-2 pr-2">
                    {topRated.map((movie) => (
                      <div
